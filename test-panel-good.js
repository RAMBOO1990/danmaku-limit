...
`));
	...
	var _dlIsShow = (0, vue.ref)(false);
	var App_default = (0, vue.defineComponent)({
		__name: "App",
		setup(__props) {
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", null, [
					(0, vue.withDirectives)((0, vue.createVNode)(PanelComp_default, {
						title: "Hello World 测试",
						widthPercent: 30,
						heightPercent: 30,
						minWidth: 300,
						minHeight: 200,
						onClose: () => { _dlIsShow.value = false; }
					}), [[vue.vShow, _dlIsShow.value]])
				]);
			};
		}
	});
	...
	var menu = () => {
		_GM_registerMenuCommand("🧪 测试面板", () => {
			_dlIsShow.value = !_dlIsShow.value;
		});
	};
